...
public class ConsumerTest{
        ...
        //create interactions
            return builder.given("Request to create a user")
                    ...
                    .willRespondWith()
                        .status(201)
                        .body(reqResBody)
                    /*.given("Request to retrieve a user")
                    .uponReceiving("Request to retrieve a user")
                        .method("GET")
                        .path(resourcePath)
                        .headers(reqHeaders)
                        .body(reqResBody)
    ...
    public void consumerTest(){
        ...
        reqBody.put("id",123);
        reqBody.put("firstName","Preeti");
        reqBody.put("lastName","Jha");
        reqBody.put("email","preetijha423@gmail.com");
